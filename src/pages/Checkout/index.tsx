...
const Checkout = () => {
  const [payWithCard, setWithCard] = useState(false)
  ...
  return (
    <form onSubmit={form.handleSubmit} className="container">
      ...
      <Card title="Pagamento">
        <>
          <TagButton isActive={!payWithCard} onClick={() => setWithCard(false)}>
            <img src={boleto} alt="Boleto Bancário" />
            Boleto bancário
          </TagButton>
          <TagButton isActive={payWithCard} onClick={() => setWithCard(true)}>
            ...
            {payWithCard ? (
              <>
                ...
                <Row marginTop="24px">
                  ...
                  <InputGroup>
                    <label htmlFor="cardNumber">Número do cartão</label>r
                    <input
                      id="cardNumber"
                      type="text"
                      name="cardNumber"
